                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="hero-banner-content black-color">
                            ...
                            <div class="btn-box">
                                <a href="<?= base_url(); ?>/courses" class="default-btn"><i class='bx bx-move-horizontal icon-arrow before'></i><span class="label">View Courses</span><i class="bx bx-move-horizontal icon-arrow after"></i></a>
                                <a href="<?= base_url(); ?>/contact" class="optional-btn">Get Started Free</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="hero-banner-image text-center">
                            <img src="<?= base_url(); ?>themes/img/banner-img3.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shorting">
            <div class="row">
                <div class="col-lg-4 col-md-6 mix business design language">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/1.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user1.jpg" class="shadow" alt="image">
                ...
                <div class="col-lg-4 col-md-6 mix design development management photography">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/2.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user2.jpg" class="shadow" alt="image">
                ...
                <div class="col-lg-4 col-md-6 mix development business management">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/3.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user3.jpg" class="shadow" alt="image">
                                    <span>Anderson</span>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 mix language design development photography">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/4.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user4.jpg" class="shadow" alt="image">
                                    <span>Liam King</span>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 mix management design photography">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/5.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user5.jpg" class="shadow" alt="image">
                                    <span>Lina</span>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 mix photography design development photography">
                    <div class="single-courses-item mb-30">
                        <div class="courses-image">
                            <a href="single-courses.html" class="d-block"><img src="<?= base_url(); ?>themes/img/courses/6.jpg" alt="image"></a>
                        </div>

                        <div class="courses-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="course-author d-flex align-items-center">
                                    <img src="<?= base_url(); ?>themes/img/user6.jpg" class="shadow" alt="image">
        ...
        <div class="partner-slides owl-carousel owl-theme">
            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/7.png" alt="image">
                </a>
            </div>

            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/8.png" alt="image">
                </a>
            </div>

            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/9.png" alt="image">
                </a>
            </div>

            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/10.png" alt="image">
                </a>
            </div>

            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/11.png" alt="image">
                </a>
            </div>

            <div class="single-partner-item">
                <a href="#" class="d-block">
                    <img src="<?= base_url(); ?>themes/img/partner/12.png" alt="image">
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="become-instructor-partner-image bg-image1 jarallax" data-jarallax='{"speed": 0.3}'>
                    <img src="<?= base_url(); ?>themes/img/become-instructor.jpg" alt="image">
                </div>
            </div>

            <div class="col-lg-6 col-md-6">
                <div class="become-instructor-partner-image bg-image2 jarallax" data-jarallax='{"speed": 0.3}'>
                    <img src="<?= base_url(); ?>themes/img/become-partner.jpg" alt="image">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="testimonials-slides owl-carousel owl-theme">
            <div class="single-testimonials-item">
                ...
                <div class="info">
                    <img src="<?= base_url(); ?>themes/img/user1.jpg" class="shadow rounded-circle" alt="image">
                    <h3>John Smith</h3>
                    <span>Student</span>
                </div>
            </div>
            ...
            <div class="single-testimonials-item">
                ...
                <div class="info">
                    <img src="<?= base_url(); ?>themes/img/user2.jpg" class="shadow rounded-circle" alt="image">
                    <h3>Sarah Taylor</h3>
                    <span>Student</span>
                </div>
            </div>
            ...
            <div class="single-testimonials-item">
                ...
                <div class="info">
                    <img src="<?= base_url(); ?>themes/img/user3.jpg" class="shadow rounded-circle" alt="image">
                    <h3>David Warner</h3>
                    <span>Student</span>
                </div>
            </div>
            ...
            <div class="single-testimonials-item">
                ...
                <div class="info">
                    <img src="<?= base_url(); ?>themes/img/user4.jpg" class="shadow rounded-circle" alt="image">
    ...
    <div class="container">
        ...
        <div class="blog-slides owl-carousel owl-theme">
            <div class="single-blog-post mb-30">
                <div class="post-image">
                    <a href="single-blog.html" class="d-block">
                        <img src="<?= base_url(); ?>themes/img/blog/1.jpg" alt="image">
                    </a>
                ...
                <div class="post-content">
                    <ul class="post-meta">
                        <li class="post-author">
                            <img src="<?= base_url(); ?>themes/img/user1.jpg" class="d-inline-block rounded-circle mr-2" alt="image">
            ...
            <div class="single-blog-post mb-30">
                <div class="post-image">
                    <a href="single-blog.html" class="d-block">
                        <img src="<?= base_url(); ?>themes/img/blog/2.jpg" alt="image">
                    </a>
                ...
                <div class="post-content">
                    <ul class="post-meta">
                        <li class="post-author">
                            <img src="<?= base_url(); ?>themes/img/user2.jpg" class="d-inline-block rounded-circle mr-2" alt="image">
            ...
            <div class="single-blog-post mb-30">
                <div class="post-image">
                    <a href="single-blog.html" class="d-block">
                        <img src="<?= base_url(); ?>themes/img/blog/3.jpg" alt="image">
                    </a>
                ...
                <div class="post-content">
                    <ul class="post-meta">
                        <li class="post-author">
                            <img src="<?= base_url(); ?>themes/img/user3.jpg" class="d-inline-block rounded-circle mr-2" alt="image">
            ...
            <div class="single-blog-post mb-30">
                <div class="post-image">
                    <a href="single-blog.html" class="d-block">
                        <img src="<?= base_url(); ?>themes/img/blog/4.jpg" alt="image">
                    </a>
                ...
                <div class="post-content">
                    <ul class="post-meta">
                        <li class="post-author">
                            <img src="<?= base_url(); ?>themes/img/user5.jpg" class="d-inline-block rounded-circle mr-2" alt="image">
            ...
            <div class="single-blog-post mb-30">
                <div class="post-image">
                    <a href="single-blog.html" class="d-block">
                        <img src="<?= base_url(); ?>themes/img/blog/5.jpg" alt="image">
                    </a>
                ...
                <div class="post-content">
                    <ul class="post-meta">
                        <li class="post-author">
                            <img src="<?= base_url(); ?>themes/img/user6.jpg" class="d-inline-block rounded-circle mr-2" alt="image">
